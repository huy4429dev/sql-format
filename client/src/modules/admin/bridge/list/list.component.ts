...
export class ListComponent {
  ...
  constructor(
    ...
    this.titleService.setTitle("List Bridge");
  ...
  fetchData() {
    ...
    this.loadingService.isLoading.next(true);
    this.bridgeService.getAll(this.filterInput.value)
      .pipe(
        finalize(() => {
  ...
  okDelete() {
    this.loadingService.isLoading.next(true);
    this.bridgeService.delete(this.itemHandle)
      .subscribe(
        {
          next: () => {
            this.fetchData();
  ...
  okBulkDelete() {
    this.loadingService.isLoading.next(true);
    this.bridgeService.bulkDelete(this.data.filter(item => item.checked).map(item => [item.recipe_id,item.template_id]))
      .subscribe(
        {
          next: () => {
            this.fetchData();
